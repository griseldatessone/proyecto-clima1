...
## 👤 Autores
- **Alumno/a:** [GRISELDA TESSONE]
- **Curso:** [INTELIGENCIA ARTIFICIAL EM GESTION AMBIENTAL]
- **Institución:** [FORMACION LINE]
- 
🤖 Inteligencia Artificial Aplicada
Hemos incorporado un modelo de Machine Learning (Scikit-Learn) para calcular la tendencia de calentamiento. El sistema es capaz de proyectar la temperatura de la próxima hora con un margen de error basado en la progresión lineal del día.
...
Ciudad con Máxima	Santa Cruz de Tenerife       (28°C)
Tendencia IA	Ascendente                       (+1.5°C/h)
Predicción 1 hora	                            29.5°C
Estado de Alerta	                        ⚠️  Alerta Amarilla por calor
Recomendación	                                Beber agua y evitar ejercicio intenso
